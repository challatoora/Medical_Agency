const USER_API_URL = "http://34.230.89.2:5006/api/users";
const MEDICINE_API_URL = "http://34.230.89.2:5001/api/medicines";
const INVENTORY_API_URL = "http://34.230.89.2:5003/api/inventory";
const SUPPLIER_API_URL = "http://34.230.89.2:5002/api/suppliers";
const ORDER_API_URL = "http://34.230.89.2:5004/api/orders";
const BILLING_API_URL = "http://34.230.89.2:5005/api/billing";
